...
set_input_delay -clock [get_clocks {clk}] 0.0 [get_ports {in_imag[*]}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {out_real[*]}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {out_imag[*]}]
...
set_input_delay 0.0 -clock virtual_io_clk [get_ports {data_req_sink}]
