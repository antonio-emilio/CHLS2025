...
//  
//  Running on Linux HLS_student@localhost.localdomain 3.10.0-1160.el7.x86_64 x86_64 aol
//  
...
solution file add ./sc_main.cpp -type C++ -exclude true
...
directive set /top_level/FIR_FILTER/MAC -UNROLL no
go architect
go extract
