...
HD_PWD='C:/Users/Conta/Documents/GitHub/IMT/CHLS2025/TP_sysc_filter/Filtre_NexysVideo_STUDENT/proj/AudioProc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_FIR_FILTER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_FIR_FILTER.tcl
