...
HD_PWD='C:/Users/Conta/Documents/GitHub/IMT/CHLS2025/TP_sysc_filter/Filtre_NexysVideo_STUDENT/proj/AudioProc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_FIR_FILTER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_level_FIR_FILTER.tcl -notrace
